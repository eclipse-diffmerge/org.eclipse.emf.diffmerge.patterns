...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.core.gen.corepatterns.AbstractVersionedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractVersionedElementItemProvider
	 ...
	 * @generated
	 */
	public AbstractVersionedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractVersionedElement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractVersionedElement_type") : //$NON-NLS-1$
			getString("_UI_AbstractVersionedElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractVersionedElement.class)) {
