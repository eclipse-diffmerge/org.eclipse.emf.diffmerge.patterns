...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.templates.gen.templatepatterns.TextualRoleDerivationRule} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextualRoleDerivationRuleItemProvider
	extends AbstractTextualQueryItemProvider
	implements
	 ...
	 * @generated
	 */
	public TextualRoleDerivationRuleItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TextualRoleDerivationRule.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TextualRoleDerivationRule")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TextualRoleDerivationRule)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TextualRoleDerivationRule_type") : //$NON-NLS-1$
			getString("_UI_TextualRoleDerivationRule_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TextualRoleDerivationRule.class)) {
