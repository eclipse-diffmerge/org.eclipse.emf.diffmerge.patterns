...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.templates.gen.templatepatterns.TextualRoleConstraint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TextualRoleConstraintItemProvider
	 ...
	 * @generated
	 */
	public TextualRoleConstraintItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns TextualRoleConstraint.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TextualRoleConstraint")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TextualRoleConstraint)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_TextualRoleConstraint_type") : //$NON-NLS-1$
			getString("_UI_TextualRoleConstraint_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TextualRoleConstraint.class)) {
