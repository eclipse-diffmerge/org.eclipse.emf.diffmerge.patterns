...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.core.gen.corepatterns.AbstractPatternRole} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractPatternRoleItemProvider
	 ...
	 * @generated
	 */
	public AbstractPatternRoleItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractPatternRole)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractPatternRole_type") : //$NON-NLS-1$
			getString("_UI_AbstractPatternRole_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractPatternRole.class)) {
