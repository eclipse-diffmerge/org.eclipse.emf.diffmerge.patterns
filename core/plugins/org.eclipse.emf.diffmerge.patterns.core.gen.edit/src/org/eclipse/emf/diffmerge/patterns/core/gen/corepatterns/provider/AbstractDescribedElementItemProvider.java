...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.core.gen.corepatterns.AbstractDescribedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractDescribedElementItemProvider
	 ...
	 * @generated
	 */
	public AbstractDescribedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractDescribedElement)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractDescribedElement_type") : //$NON-NLS-1$
			getString("_UI_AbstractDescribedElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AbstractDescribedElement.class)) {
			case CorepatternsPackage.ABSTRACT_DESCRIBED_ELEMENT__DESCRIPTION:
