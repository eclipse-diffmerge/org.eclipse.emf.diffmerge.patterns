...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.core.gen.corepatterns.AbstractNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractNamedElementItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CorepatternsPackage.Literals.ABSTRACT_NAMED_ELEMENT__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractNamedElement_type") : //$NON-NLS-1$
			getString("_UI_AbstractNamedElement_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
