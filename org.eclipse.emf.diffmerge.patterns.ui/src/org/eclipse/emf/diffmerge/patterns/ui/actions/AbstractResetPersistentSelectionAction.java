 ...
 */
public abstract class AbstractResetPersistentSelectionAction<DiagramElementType, DiagramType, GraphicalPartType> 
  extends AbstractModelBasedAction<DiagramElementType, DiagramType, GraphicalPartType> {

	/**
	 * Constructor
	 */
	public AbstractResetPersistentSelectionAction() {
	  super();
	}
