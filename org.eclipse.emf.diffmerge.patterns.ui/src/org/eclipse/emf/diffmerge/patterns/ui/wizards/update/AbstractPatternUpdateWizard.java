 ...
 */
public abstract class AbstractPatternUpdateWizard<DiagramElementType, DiagramType>
extends AbstractPatternWizard<TemplatePatternUpdateSpecification> {
  ...
  public void doAddPages() {
    ...
    subPages.add(instantiatePatternUpdatePresentationPage(getData()));
  ...
  /**
   * Instantiates an update presentation page
   * @param data_p a non-null AbstractModifiableTemplatePatternSpecification
   * @return a non-null AbstractPatternUpdatePresentationPage
   */
  @SuppressWarnings("unchecked")
  protected AbstractPatternUpdatePresentationPage instantiatePatternUpdatePresentationPage(AbstractModifiableTemplatePatternSpecification data_p){
    AbstractPatternPageFactory factory = 
        PatternsUIPlugin.getDefault().getPageFactory();
    if(factory != null){
      return factory.instantiatePatternUpdatePresentationPage(data_p);
    }
    return null;
  }
