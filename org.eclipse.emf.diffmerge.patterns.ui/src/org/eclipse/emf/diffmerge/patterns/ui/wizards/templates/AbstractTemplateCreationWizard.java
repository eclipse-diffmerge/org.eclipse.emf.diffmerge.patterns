 ...
 * @author S. TURKI
 */
public abstract class AbstractTemplateCreationWizard<DiagramElementType, DiagramType>
extends AbstractPatternWizard<TemplatePatternCreationSpecification> {
   ...
   */
  public AbstractTemplateCreationWizard(List<? extends Object> sources_p,
  ...
  public void doAddPages() {
    ...
    //subPages.add(new AbstractTemplateCreationPresentationPage(getData()));
    subPages.add(instantiateTemplateCreationPresentationPage(getData()));
   ...
   */
  protected AbstractTemplateCreationPresentationPage<DiagramElementType, DiagramType>
