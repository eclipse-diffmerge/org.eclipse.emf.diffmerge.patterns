 ...
 * @author O. CONSTANT
 */
public abstract class AbstractTemplateCreationPresentationPage<DiagramElementType>
extends AbstractPatternPresentationPage<DiagramElementType, TemplatePatternCreationSpecification> {

  /**
   * Constructor
   * @param creationData_p the non-null data for template pattern creation
   */
  public AbstractTemplateCreationPresentationPage(TemplatePatternCreationSpecification creationData_p) {
