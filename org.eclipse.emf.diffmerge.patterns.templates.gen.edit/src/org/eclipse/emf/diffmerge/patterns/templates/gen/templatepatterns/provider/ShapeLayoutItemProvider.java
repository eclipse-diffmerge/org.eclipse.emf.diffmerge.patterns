...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.diffmerge.patterns.templates.gen.templatepatterns.ShapeLayout} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ShapeLayoutItemProvider
	 ...
	 * @generated
	 */
	public ShapeLayoutItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ShapeLayout)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_ShapeLayout_type") : //$NON-NLS-1$
			getString("_UI_ShapeLayout_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ShapeLayout.class)) {
